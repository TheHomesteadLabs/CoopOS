...
export const patreonTiers = [
  {
    ...
    price: 5,
    blurb: 'The technical layer. For makers replicating the builds.',
    features: [
      'Director\'s cut episodes (longer, deeper, more failure footage)',
      'Private GitHub repos for every build',
      'Hardware lists with pricing',
      'Discord access with Junior Engineer role',
      'Access to #build-help — get questions answered',
    ],
  ...
  },
  {
    ...
    price: 12,
    blurb: 'For supporters who want to be ahead of the build cycle.',
    features: [
      'All Junior Engineer benefits',
      'Early access to every new episode',
      'Ad-free episode versions',
      'Senior Engineer Discord role',
      'Access to #early-access — sneak peeks during production',
    ],
    image: 'senior-engineer.png',
  },
  {
    name: 'Director',
    price: 25,
    blurb: 'For supporters who want a seat at the table.',
    features: [
      'All Senior Engineer benefits',
      'Monthly board meeting (private Q&A with Brad)',
      'Your name in episode credits as Board Member',
      'Director Discord role with custom badge',
      'Access to #director-board — direct line to leadership',
    ],
    image: 'director.png',
  },
];
